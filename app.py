...
def mostrar_modulo_cuadratura_diaria(ruta_negocio):
    ...
    st.markdown("""
        <div style='background-color: #F3F4F6; padding: 12px; border-radius: 8px; margin-bottom: 15px;'>
            <strong>📌 Control de Caja Inteligente:</strong> Gestiona tus ingresos generales y activa el interruptor si necesitas separar productos con margen diferenciado (como cigarrillos). <em>Nota: Los campos ahora son de guardado manual por clic para evitar errores con la tecla Enter.</em>
        </div>
    """, unsafe_allow_html=True)
    ...
    st.divider()
    st.markdown("### 📂 Historial de Cuadraturas Registradas y Gestión")
